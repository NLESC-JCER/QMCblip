...
sys.path.append('/home/slootman/escience/CHAMP-ASE')
from champ import CHAMP

np.random.seed(12345)

atoms = Atoms('C4SH4', [(0,0.71495093597,1.31902341514), (0,-0.71495093597,1.31902341514), (0,-1.24055334534,0.05119099544), (0,1.24055334534,0.05119099544), (0.6456,0,-1.15285178278), (0,1.32194923477,2.21441153704), (0,-1.32194923477,2.21441153704), (0,2.27909548764,-0.24288695123), (0,-2.27909548764,-0.24288695123)])
...
champ_calc = CHAMP(champ_loc="/home/slootman/bin/vmc.mov1", force_file="write_forces", ncore=60, nodefile="nodefile")
